...
import com.cmrlabs.search.twitter.BaseApplication;
...
public final class MainActivity extends AppCompatActivity {
    ...
    @NonNull
    private TweetsAdapter createNewTweetsAdapter(List<Status> newTweets) {
    ...
    private void initSearchView() {
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(final String query) {
                ...
                searchTweets(query);
                //show loading and hide after loading
                return false;
            }
    ...
    public void searchTweets(final String keyword) {
        ...
        subSearchTweets = twitterApi.searchTweets(keyword)
                ...
                .subscribe(new Subscriber<List<Status>>() {
                    ...
                    @Override
                    public void onStart() {
                        toolbar.setTitle("Search tweets");
                        setSupportActionBar(toolbar);

                        textViewMessage.setText("Tweets Loading...");
                        progressLoadingMoreTweets.setVisibility(View.VISIBLE);
